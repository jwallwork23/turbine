...
def get_error_estimators(mesh2d, iteration=0, op=TurbineOptions()):
    ...
    with pyadjoint.stop_annotating():
        ...
        if op.approach == 'AdjointOnly':
            ...
            bc3 = assemble(i*g*dot(z, n)*ds(3))
            print('bc0_1_max: {:.4e} {:.4e}'.format(max(bc0_1.dat.data[:,0]), max(bc0_1.dat.data[:,1])))
            print('bc0_1_min: {:.4e} {:.4e}'.format(min(bc0_1.dat.data[:,0]), max(bc0_1.dat.data[:,1])))
            print('bc0_2_max: {:.4e} {:.4e}'.format(max(bc0_2.dat.data[:,0]), max(bc0_2.dat.data[:,1])))
            print('bc0_2_min: {:.4e} {:.4e}'.format(min(bc0_2.dat.data[:,0]), max(bc0_2.dat.data[:,1])))
            print('bc0_3_max: {:.4e} {:.4e}'.format(max(bc0_3.dat.data[:,0]), max(bc0_3.dat.data[:,1])))
            print('bc0_3_min: {:.4e} {:.4e}'.format(min(bc0_3.dat.data[:,0]), max(bc0_3.dat.data[:,1])))
            print('bc1_max: {:.4e}'.format(max(bc1.dat.data)))
            print('bc1_min: {:.4e}'.format(min(bc1.dat.data)))
            print('bc2_max: {:.4e} {:.4e}'.format(max(bc2.dat.data[:,0]), max(bc2.dat.data[:,1])))
            print('bc2_min: {:.4e} {:.4e}'.format(min(bc2.dat.data[:,0]), min(bc2.dat.data[:,1])))
            print('bc3_max: {:.4e}'.format(max(bc3.dat.data)))
            print('bc3_min: {:.4e}'.format(min(bc3.dat.data)))
            return
        ...
        epsilon.interpolate(abs(epsilon))
